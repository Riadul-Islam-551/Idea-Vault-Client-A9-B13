...
const Methodology = () => {
  return (
    <div className="container mx-auto px-7 my-16 ">
      ...
      <p className="text-gray-600 dark:text-[#b5b5b5] text-center my-3 mb-8 ">By the end of the services, you don’t just have an idea <br /> you have a validated concept shaped by real feedback from a creative community.</p>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-6 gap-12 ">
        {/* service 1  */}
        <div className="hover-3d ">
          <div className="card bg-gray-100 dark:bg-[#212121]  shadow-sm">
            <div className="card-body">
              <h2 className="card-title">Discover Ideas</h2>
              <p className="text-gray-600 dark:text-[#b5b5b5] ">
              ...
              <div className="mt-4 text-gray-600 dark:text-[#b5b5b5]">
        ...
        <div className="hover-3d ">
          <div className="card bg-gray-100 dark:bg-[#212121] shadow-sm">
            <div className="card-body">
              ...
              <div className="mt-4 ">
                <h3 className="font-semibold ">What you can do:</h3>
                <ul className="list-disc ml-4 text-gray-600 dark:text-[#b5b5b5]">
        ...
        <div className="hover-3d ">
          <div className="card bg-gray-100 dark:bg-[#212121]  shadow-sm">
            <div className="card-body">
              ...
              <p className="text-gray-600 dark:text-[#b5b5b5] text-justify ">
